...
import 'widgets/adoption_pet_card_skeleton.dart'; // تأكد من استيراد الملف الجديد
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return ListView.builder(
                    ...
                    itemCount: 3, 
                    itemBuilder: (context, index) => const AdoptionPetCardSkeleton(),
                  );
                }
                ...
                // --- حالة عدم وجود بيانات (Network Image Illustration) ---
                          ...
                          Container(
                            ...
                            child: ClipOval(
                              child: Image.network(
                                ...
                                fit: BoxFit.cover,
                                errorBuilder: (ctx, _, __) => const Icon(Icons.pets, size: 80, color: Colors.grey),
                              ),
                            ),
                          ),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          isExpanded: true,
          hint: Text(hint, style: const TextStyle(color: AppColors.textDark, fontSize: 14)),
